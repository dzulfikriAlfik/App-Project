        ...
        <div class="col-md-12">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <a href="{{ url('kegiatan/list/add') }}" class="btn btn-sm btn-info"><i class="fas fa-plus"></i> Tambah</a>
            </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="{{ url("kegiatan/list/{$gallery->id}/edit") }}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> Edit</a>
                      <a href="{{ url("kegiatan/{$gallery->id}/delete") }}" class="btn btn-sm btn-danger" onclick="return confirm('Yakin hapus data ini?')"><i class="fas fa-trash"></i> Hapus</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
