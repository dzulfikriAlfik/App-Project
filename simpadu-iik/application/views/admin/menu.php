        ...
        <ul class="navigation navigation-main navigation-accordion">
          ...
          <li>
            ...
            <ul>
              ...
              <li class="<?php echo menuaktif('kelahiran', $aktif); ?>"><a href="<?php echo site_url('Entry/kelahiran'); ?>"><i class="icon-user-plus"></i> <span>Data Kelahiran</span></a></li>

              <li class="<?php echo menuaktif('kematian', $aktif); ?>"><a href="<?php echo site_url('Entry/kematian'); ?>"><i class="icon-user-minus"></i> <span>Data Kematian</span></a></li>
