...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    <table class="table table-bordered">
      ...
      <tr>
        <th>Kepala Desa</th>
        <td><?php if ($getrow['kepala_desa'] == "") {
              echo '<i>Belum Di Update</i>';
            } else {
              echo $getrow['kepala_desa'];
            } ?></td>
      </tr>
      <tr>
        <th>Alamat</th>
        <td><?php echo $getrow['alamat_desa']; ?></td>
      </tr>
      <tr>
        <th>No. Telp</th>
        <td><?php echo $getrow['telp']; ?></td>
      </tr>
      <tr>
        <th>Kode Pos</th>
        <td><?php echo $getrow['kode_pos']; ?></td>
      </tr>
    </table>
  </div>
</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class='col-md-9'>
              <input type="text" name="alamat_desa" autocomplete="off" value="<?php echo $getrow['alamat_desa']; ?>" required placeholder="Masukkan Alamat Desa" class="form-control">
            </div>
          </div>
          <br>
          <div class="form-group">
            ...
            <div class='col-md-9'>
              <input type="text" name="telp" autocomplete="off" value="<?php echo $getrow['telp']; ?>" required placeholder="Masukkan No. Telp" class="form-control">
            </div>
          </div>
          <br>
          <div class="form-group">
            ...
            <div class='col-md-9'>
              <input type="text" name="kode_pos" autocomplete="off" value="<?php echo $getrow['kode_pos']; ?>" required placeholder="Masukkan Kode Pos" class="form-control">
            </div>
          </div>
          <br>
        </div>
