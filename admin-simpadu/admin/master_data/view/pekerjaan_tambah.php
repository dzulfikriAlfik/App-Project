         ...
         <div class="row d-flex justify-content-center">
            <div class="col-md-6">
               <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form id="pekerjaanValidator" method="post" action="<?= baseUrl('admin/master_data/aksi/pekerjaan_add'); ?>">
                     <div class="card-body">
                        <div class="row">
                           <div class="form-group col-md-12">
                              <label for="pekerjaan">Jenis Pekerjaan</label>
                              <input type="text" name="pekerjaan" class="form-control" id="pekerjaan" placeholder="Masukan Jenis Pekerjaan" autofocus>
                           </div>
                        </div>
                     </div>
                     <!-- /.card-body -->
