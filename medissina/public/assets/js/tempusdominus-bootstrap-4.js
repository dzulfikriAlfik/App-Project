...
+(function () {
   ...
   var DateTimePicker = (function ($, moment) {
      ...
      var DateTimePicker = /*#__PURE__*/ (function () {
         ...
         _proto._handlePromptTimeIfNeeded = function _handlePromptTimeIfNeeded(
            e
         ) {
         ...
         _proto._isInDisabledDates = function _isInDisabledDates(testDate) {
            return (
               this._options.disabledDates[testDate.format("YYYY-MM-DD")] ===
               true
            );
         };
         ...
         _proto._isInEnabledDates = function _isInEnabledDates(testDate) {
            return (
               this._options.enabledDates[testDate.format("YYYY-MM-DD")] ===
               true
            );
         };
         ...
         _proto._isValid = function _isValid(targetMoment, granularity) {
            ...
            if (
               ...
               granularity === "d" &&
               this._options.daysOfWeekDisabled.indexOf(targetMoment.day()) !==
                  -1
            ) {
               return false;
            }
               ...
               if (
                  ...
                  if (
                     ...
                     for (
                        ...
                        if (
                           !(KeyMap[keyBindKeys[index2]] in pressedModifiers)
                        ) {
         ...
         _proto.updateOnlyThroughDateOption =
            function updateOnlyThroughDateOption(_updateOnlyThroughDateOption) {
      ...
      var TempusDominusBootstrap4 = /*#__PURE__*/ (function (_DateTimePicker) {
         ...
         _proto2._fillTime = function _fillTime() {
            ...
            lastPickedDate &&
               timeComponents
                  ...
                  .text(
                     lastPickedDate.format("" + (this.use24Hours ? "HH" : "hh"))
                  );
            lastPickedDate &&
               timeComponents
         ...
         _proto2.widgetPositioning = function widgetPositioning(
            ...
            if (_widgetPositioning.horizontal) {
               ...
               if (
                  horizontalModes.indexOf(_widgetPositioning.horizontal) === -1
               ) {
                  throw new TypeError(
