...
Route::group(['middleware' => ['login', 'admin']], function () {
  ...
  Route::prefix('mitra')->group(function () {
    ...
    // chat
    Route::get('/chat', [AdminController::class, "listChat"]);
    Route::get('/chat/{user}', [AdminController::class, "chatUser"]);
    Route::get('/chat/{user}/send', [AdminController::class, "sendChat"]);
    Route::post('/chat/{user}/send', [AdminController::class, "storeChat"]);
    Route::get('/chat/{chat}/{user}/delete', [AdminController::class, "deleteChat"]);
  });
...
Route::group(['middleware' => ['login', 'mitra']], function () {
  // chat
  Route::get('/chat', [MitraController::class, "chatUser"]);
  Route::get('/chat/send', [MitraController::class, "sendChat"]);
  Route::post('/chat/send', [MitraController::class, "storeChat"]);
  Route::get('/chat/{chat}/delete', [MitraController::class, "deleteChat"]);
});
