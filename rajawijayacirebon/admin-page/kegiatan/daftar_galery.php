                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="card mb-4 shadow-sm">
                            <img class="rounded img-fluid img-thumbnail" style="width:100%; height:55vh;" src="<?= baseUrl('admin-page/assets/img/kegiatan/') . $galery['foto'] ?>">                        
                            <div class="card-body">
                              <p class="card-text"><?= $galery['keterangan'] ?></p>
                              <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                  <a href="hapus_galery?id=<?= $galery['id_galery_kegiatan'] ?>" onclick="return confirm('Yakin hapus data?')" class="btn btn-sm btn-danger">Hapus</a>
                                </div>
