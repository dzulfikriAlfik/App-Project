...
<div class="content-wrapper">
   ...
   <!-- Main content -->
   <?php
   $rows = single_query("SELECT * FROM company_profile");
   ?>
   <div class="content">
      <div class="container-fluid">
         <div class="row">
               ...
               <div class="card card-primary card-outline">
                  <div class="card-body box-profile">
                     <div class="text-center">
                        <img class="profile-user-img img-fluid img-thumbnail rounded w-50" src="<?= baseUrl('assets/img/logo/' . $rows['logo']); ?>" alt="User profile picture">
                     </div>
                     <h2 class="text-center my-3 company-name"><?= $rows['company_name']; ?></h2>
                     <ul class="list-group list-group-unbordered mb-3">
                        <!-- Form -->
                        <form action="action/company_ubah_data" method="post" enctype="multipart/form-data">
                           ...
                           <li class="list-group-item">
                              ...
                              <div class="form-group">
                                 ...
                                 <br>
                                 <img class="profile-user-img img-fluid img-circle mb-3" src="<?= baseUrl('assets/img/logo/' . $rows['logo']); ?>" alt="Logo">
