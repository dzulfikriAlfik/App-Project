...
<a href="{{ route('barang_keluars.create')}}"><button style="background:blue; margin:5px; padding:10px 5px; border-radius:5px; cursor: pointer;">Tambah</button></a>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <body>
                  <tbody>
      @foreach ($barang_keluars as $post)
      <tr>
      <td style="width: 200px" >{{ $post->No_bon}}</td>
        <td style="width: 500px" >{{ $post->Tgl }}</td>
        <td style="width: 500px" >{{ $post->Kode_barang }}</td>
