...
<div class="wrapper">
  <h1></h1>
  <a href="{{ route('data_barangs.index')}}"><button style="background:blue; margin:5px; padding:10px 5px; border-radius:5px; cursor: pointer;">Kembali</button></a>
  ...
  @endif  
    @csrf
    <form method="POST" action="{{ url('data_barangs') }}">
    @csrf
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="row">
        <div class="col-sm-8">
          ...
          <div class="form-group">
            ...
            <input type="text" name="Harga_barang" class="form-control" placeholder="Enter ...">
          </div>
        </div>
        </div>
        </div>
