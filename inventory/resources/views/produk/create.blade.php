                  ...
                  <div class="row d-flex justify-content-center">
                     <div class="col-md-5 mx-auto">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="jumlah_barang" id="jumlah_barang" class="form-control @error('jumlah_barang') is-invalid @enderror" placeholder="Jumlah Barang" value="{{ old('jumlah_barang') }}">
                           @error('jumlah_barang')
                           <small class="invalid-feedback">{{ $message }}</small>
                           @enderror
                        </div>
