...
<div class="row">
  <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
    ...
    <p class="lead">Documentation and examples for adding Bootstrap popovers, like those found in iOS, to any element on your site. Read the <a href="https://getbootstrap.com/docs/4.5/components/popovers/" target="_blank">Official Bootstrap Documentation</a> for a full list of instructions and other options.</p>
