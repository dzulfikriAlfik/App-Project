...
<div class="row">
  <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
    ...
    <p class="lead">A slideshow component for cycling through elements—images or slides of text—like a carousel. Read the <a href="https://getbootstrap.com/docs/4.5/components/breadcrumb/" target="_blank">Official Bootstrap Documentation</a> for a full list of instructions and other options.</p>
      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="{{ url('assets/images/placeholder.jpg') }}" class="d-block w-100" alt="...">
          </div>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
	<div class="carousel-inner">
		<div class="carousel-item active">
      ...
      <button type="button" class="btn btn-clipboard" data-clipboard-target="#slidesOnly"><i data-feather="copy"></i></button>
    </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img src="..." class="d-block w-100" alt="...">
		</div>
	...
	<a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
      ...
      <button type="button" class="btn btn-clipboard" data-clipboard-target="#withControls"><i data-feather="copy"></i></button>
    </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
	<ol class="carousel-indicators">
		<li data-target="#carouselExampleIndicators" data-slide-to="0" class="active"></li>
		<li data-target="#carouselExampleIndicators" data-slide-to="1"></li>
		<li data-target="#carouselExampleIndicators" data-slide-to="2"></li>
	...
	<a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
      ...
      <button type="button" class="btn btn-clipboard" data-clipboard-target="#withIndicators"><i data-feather="copy"></i></button>
    </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="example">
	<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
      ...
      <button type="button" class="btn btn-clipboard" data-clipboard-target="#withCaptions"><i data-feather="copy"></i></button>
    </figure>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img src="..." class="d-block w-100" alt="...">
		</div>
	...
	<a class="carousel-control-next" href="#carouselExampleFade" role="button" data-slide="next">
      ...
      <button type="button" class="btn btn-clipboard" data-clipboard-target="#crossfadeCarousel"><i data-feather="copy"></i></button>
    </figure>
