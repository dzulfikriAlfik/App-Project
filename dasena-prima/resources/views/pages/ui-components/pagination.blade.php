...
<div class="row">
  <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
    ...
    <p class="lead">To indicate a series of related content exists across multiple pages. Read the <a href="https://getbootstrap.com/docs/4.5/components/pagination/" target="_blank">Official Bootstrap Documentation</a> for a full list of instructions and other options.</p>
